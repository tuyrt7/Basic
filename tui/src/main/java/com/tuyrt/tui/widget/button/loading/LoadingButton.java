package com.tuyrt.tui.widget.button.loading;
...
import com.tuyrt.tui.R;
import com.tuyrt.tui.util.DensityUtils;
 ...
 *
 *  https://github.com/FlodCoding/LoadingButton loading效果
 */
...
public class LoadingButton extends DrawableTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int loadingStokeWidth = array.getDimensionPixelSize(R.styleable.LoadingButton_loadingStokeWidth, DensityUtils.dp2px(3));
        ...
        mLoadingDrawable.setStrokeWidth(loadingStokeWidth);
